...
    try {
      // Esta chamada de API para download ainda está ativa. Se estiver usando a simulação,
      // certifique-se de que este endpoint /api/energent/download funcione ou ajuste-o.
...
            {files.map((f, i) => {
              const originalName = f; // Nome do arquivo upado
              const processedName = f.replace(/\.[^/.]+$/, "_processado.pdf"); // Nome do arquivo para download
              return (
...
                    {/* EXIBE O NOME DO ARQUIVO UPADO AQUI */}
